...
<table border=3 align = 'center'>
  <thead>
      <tr style="text-align: center;"  >
        ...
        <th style="text-align: center; width: 250px; font-size: 20px ">Username</th>
...
if ($Users){
      ...
      ?>
        <tr  >
          ...
          <td align="center"><?PHP echo $P->getUsername(); ?></td>>
          <td align="center"><?PHP echo $P->getEmail(); ?></td>>
          <td align="center"><?PHP echo $P->getRole(); ?></td>>
          <td  align="center">
            <a style="margin: 5px; "  class="btn btn-danger"  href="Delete_User.php?id=<?php echo $P->getId(); ?>" name="supprimer" value="supprimer" type="button">Supprimer</a>
          </td>
          <td  align="center">
            <a style="margin: 5px; "  class="btn btn-warning"  href="Update_User_Back.php?id=<?php echo $P->getId(); ?>" name="update" value="update" type="button">Update</a>
          </td>
          </tr>
      <?PHP
        }}
